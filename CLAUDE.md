...
- **Czego NIE zrobiono:** notki i zdjecia zostaja WSPOLNE na pozycji (`short_desc`, `images[]`), nie sa rozbite na per-usera (lustro `pin_ratings`/`pin_photos`) - to osobny krok, gdy okaze sie potrzebny. Patrz memory `project_list_cocreation_architecture`.
