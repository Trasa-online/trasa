...
- **Czego NIE zrobiono:** ZDJECIA przy miejscu zostaja wspolne (`discovery_items.images[]`), nie sa rozbite na per-usera (lustro `pin_photos`) - osobny krok, gdy okaze sie potrzebny. Patrz memory `project_list_cocreation_architecture`.
