...
export default function CoverPickerSheet({
  ...
  return (
    <div className="fixed inset-0 z-[95] flex items-end justify-center" onClick={onClose}>
      ...
      <div {...dragProps} onClick={(e) => e.stopPropagation()} className="relative w-[calc(100%-16px)] mx-2 mb-2 max-w-lg bg-card rounded-3xl px-5 pt-3 pb-[max(20px,env(safe-area-inset-bottom))] shadow-2xl animate-in slide-in-from-bottom-4 duration-300" style={{ ...dragProps.style, maxHeight: "82dvh" }}>
