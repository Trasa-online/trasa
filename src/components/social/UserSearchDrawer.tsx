...
export default function UserSearchDrawer({ open, onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col">
      ...
      <div {...dragProps} className="relative mt-auto mx-2 mb-[calc(0.5rem+var(--kb,0px))] bg-background rounded-[40px] flex flex-col overflow-hidden" style={{ ...dragProps.style, height: "88dvh" }}>
        {/* Handle */}
