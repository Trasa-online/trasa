...
import { Bookmark, ChevronUp, CircleDashed, Heart, Minimize2, EyeOff } from "lucide-react";
import { BrandTrash, BrandPencil } from "@/components/BrandIcon";
      ...
      <div className="absolute right-3 bottom-4 z-10 flex flex-col items-center gap-2.5">
        ...
        {onEdit && (
          <button
            ...
            className="h-12 w-12 rounded-full bg-white flex items-center justify-center shadow-lg active:scale-90 transition-transform"
          >
            <BrandPencil className="h-5 w-5 text-foreground" strokeWidth={2} />
          </button>
        )}
        {onDelete && (
          <button
