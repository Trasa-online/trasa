...
// overflow: visible - sciezka wypelnia caly viewBox, wiec polowa konturu wychodzi poza jego
// krawedz i bez tego byla UCINANA (zgloszenie Nat 2026-09-14: puste serce obciete z prawej).
export function BrandHeart({ filled = true, className = "", strokeWidth = 34 }: { filled?: boolean; className?: string;
  ...
  strokeWidth?: number }) {
  return (
    <svg viewBox={HEART_VIEWBOX} className={className} aria-hidden style={{ overflow: "visible" }}>
