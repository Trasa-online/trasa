...
import { Camera, X, MapPin, Star, Trash2 } from "lucide-react";
...
export const PinVisitDrawer = ({
  ...
  // Sync state when drawer opens or existingVisit changes
  useEffect(() => {
    if (open) {
        ...
        <DrawerContent className="max-h-[90vh]">
          ...
          <div className="px-4 pb-4 space-y-5 overflow-y-auto">
            ...
            <div className="space-y-2">
              ...
              {submitted && rating === 0 && (
                <p className="text-xs text-destructive text-center">Ocena jest wymagana</p>
              )}
            </div>
