...
export default function TrialModal({ open, onClose }: TrialModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-end sm:items-center justify-center">
      ...
      <div {...dragProps} className="relative bg-white w-[calc(100%-16px)] mx-2 mb-2 sm:max-w-sm rounded-[40px] overflow-hidden shadow-2xl flex flex-col" style={{ ...dragProps.style, maxHeight: "90dvh" }}>
