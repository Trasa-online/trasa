    ...
    <div className="flex flex-col h-[100dvh] bg-background max-w-lg mx-auto">
      ...
      <div className="flex items-center gap-2 px-4 pt-safe-4 pb-3 border-b border-border/20 shrink-0">
        ...
        {searchOpen && step === 4 ? (
          ...
          <>
            {/* Inline category filter chip - "Wszystko" / "Restauracja" / "3 kategorie" */}
            <button
              onClick={() => setCategoryDrawerOpen(true)}
              className="flex-1 min-w-0 flex items-center gap-2 px-3 py-1.5 rounded-full bg-card border border-border/60 active:scale-[0.97] transition-transform"
            >
      ...
      {/* Category filter drawer - multi-select chips */}
      <Sheet open={categoryDrawerOpen} onOpenChange={setCategoryDrawerOpen}>
        <SheetContent side="bottom" className="rounded-t-3xl p-0 [&>button]:hidden" style={{ maxHeight: "80vh" }}>
          <button
