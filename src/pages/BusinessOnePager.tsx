  ...
  if (done) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-slate-500 max-w-xs mx-auto">Odezwiemy się w ciągu 24h i pomożemy uruchomić profil Twojego lokalu.</p>
      </div>
    );
  }
...
export default function BusinessOnePager() {
  ...
  return (
    <div className="min-h-screen bg-[#FEFEFE]">
      ...
      {/* Nav */}
      <div className="sticky top-0 z-50 bg-white/90 backdrop-blur-sm border-b border-slate-100 px-5 h-14 flex items-center justify-between">
      ...
      <section className="py-16 px-5">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 items-stretch">
            {TIERS.map((tier) => (
              <div key={tier.id} className="rounded-3xl p-6 flex flex-col bg-white border border-slate-200 shadow-sm">
                {/* Header */}
