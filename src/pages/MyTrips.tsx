      ...
      <div className="flex-1 overflow-y-auto pb-24">
        ...
        <div className="px-5 pt-2 pb-0 max-w-lg mx-auto">
          <div className="flex items-center justify-between pt-3 pb-2">
            ...
            <button onClick={() => navigate("/plan")} className="text-sm font-semibold text-primary">{t("trips.add_plus")}</button>
          </div>
                            ...
                            .map((route: any) => (
                              <div key={route.id} className="border-t border-border/50">
                                <TripDayView
                                  ...
                                  dateLabel={(() => { const d = safeDate(route.start_date); return d ? format(d, "dd.MM.yyyy") : null; })()}
