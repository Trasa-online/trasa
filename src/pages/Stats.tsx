  ...
  return (
    <div className="min-h-[100dvh] bg-background max-w-lg mx-auto flex flex-col">
      ...
      <div className="flex items-center gap-3 px-4 pt-safe-4 pb-3 border-b border-border/20 shrink-0">
        <button onClick={() => goBackOr(navigate, "/moj-profil")} aria-label={t("stats.back")} className="h-9 w-9 -ml-1 flex items-center justify-center rounded-full text-foreground active:scale-90 transition-transform">
      ...
      <div className="flex-1 px-4 py-6 space-y-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">{t("stats.desc")}</p>
        </div>
