    ...
    <div className={`min-h-screen flex flex-col ${businessMode ? "bg-blue-950" : "bg-background"}`}>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 pt-12 pb-6">
        ...
        <div className="w-full max-w-sm">
          ...
          <button
            onClick={() => navigate("/")}
            className="w-full py-3.5 rounded-full border-2 border-orange-600/30 bg-primary/5 text-sm font-bold text-orange-700 active:scale-[0.97] transition-transform flex items-center justify-center gap-2 mt-2"
          >
