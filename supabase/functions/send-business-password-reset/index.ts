...
<body style="margin:0;padding:0;background:#F4F4F5;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Arial,sans-serif;color:#0E0E0E;">
  <div style="max-width:480px;margin:0 auto;padding:48px 32px;text-align:center;">
    <img src="https://spontaway.com/icon-192.png" alt="spontaway" width="64" height="64" style="display:block;width:64px;height:64px;border-radius:50%;margin:0 auto 20px;" />
    ...
    <p style="font-size:13px;color:#979797;margin:0 0 8px;">Masz problem? Napisz na&#160;<a href="mailto:hello@spontaway.com" style="color:#2563EB;text-decoration:none;">hello@spontaway.com</a></p>
