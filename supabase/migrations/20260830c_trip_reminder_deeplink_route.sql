-- Deep-link przypomnienia trip_reminder ZAWSZE do /route/:id (2026-08-30): stepper podsumowania
-- zniknal z flow, publikacja odbywa sie w widoku wyjazdu. Definicja z ZYWEJ funkcji.
