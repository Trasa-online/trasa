-- Copy pushy: "lista" -> "kolekcja" (decyzja Nat 2026-09-13: w calej apce "Listy" nazywaja sie
-- "Kolekcje"; sciezki /lista/... i nazwy tabel zostaja). Tresc funkcji = ZYWA definicja z prod
-- (pg_get_functiondef) z podmienionymi napisami, zeby nie cofnac zadnej z wczesniejszych zmian
-- wprowadzanych poza repo (patrz memory: notify_push modyfikuj z zywej definicji).
